            ...
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <motion.button
                  ...
                  className={`px-6 py-3 bg-gradient-to-r from-${PRIMARY_COLOR}-600 to-indigo-600 text-white rounded-full hover:from-${PRIMARY_COLOR}-700 hover:to-indigo-700 transition-all font-semibold shadow-lg hover:shadow-xl`}
                >
                  Start New Chat
                </motion.button>
              </div>
