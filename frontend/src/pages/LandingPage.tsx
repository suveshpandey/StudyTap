            ...
            <div>
              ...
              {!isAuthenticated && (
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6">
                  <Link
                    to="/signup"
                    className={`flex-1 sm:flex-none px-8 py-3.5 bg-${PRIMARY_COLOR}-600 text-white rounded-full hover:bg-${PRIMARY_COLOR}-700 transition-all duration-300 font-semibold text-sm sm:text-base shadow-lg shadow-${PRIMARY_COLOR}-500/40 hover:shadow-xl text-center`}
                  >
                    Start Learning Now
                  </Link>
                  <Link
                    to="/login"
                    className={`flex-1 sm:flex-none px-8 py-3.5 text-${PRIMARY_COLOR}-600 bg-white border border-${PRIMARY_COLOR}-200 rounded-full hover:bg-${PRIMARY_COLOR}-50 transition-colors duration-300 font-semibold text-sm sm:text-base text-center`}
                  >
                    Sign In
                  </Link>
                </div>
