          ...
          >
            ...
            <div className="p-6 border-b border-gray-200/40">
              ...
              <motion.button
                ...
                className="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-200 font-semibold text-sm flex items-center justify-center gap-3 shadow-lg hover:shadow-xl"
              >
