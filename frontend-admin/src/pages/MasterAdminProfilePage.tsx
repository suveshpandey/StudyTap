...
// Description: Master admin profile management page for viewing profile and changing password
// -----------------------------------------------------------------------------
...
const MasterAdminProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50/50 to-indigo-50/50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-3xl font-extrabold text-gray-900 mb-2">Master Admin Profile</h1>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  readOnly
                  disabled
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 text-gray-600 cursor-not-allowed focus:outline-none focus:border-blue-500"
                />
          ...
          >
            ...
            <form onSubmit={handleChangePassword} className="space-y-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer font-medium"
              >
                {changingPassword ? (
                  <>
