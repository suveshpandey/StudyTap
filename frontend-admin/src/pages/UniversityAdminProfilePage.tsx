...
// Description: University admin profile management page matching StudentProfilePage UI/UX
// -----------------------------------------------------------------------------
...
import { getUniversityAdminProfile, changeUniversityAdminPassword, getUniversityDetails } from '../api/client';
...
const UniversityAdminProfilePage = () => {
  ...
  const [loadingUniversityDetails, setLoadingUniversityDetails] = useState(true);
                ...
                <div className="px-8 pb-8">
                  <div className="flex items-end justify-between -mt-16 mb-6">
                    <div className="flex items-end gap-6">
                      ...
                      <div className="pb-2">
                        <h3 className="text-2xl font-bold text-gray-900 mb-1">{name || 'University Admin'}</h3>
                        <p className="text-gray-600 mb-2">{email || 'admin@university.edu'}</p>
                  ...
                  <div className="grid grid-cols-4 gap-6">
                    <div className="text-center p-4 bg-gray-50 rounded-xl border border-gray-200">
                      <div className="text-3xl font-bold text-gray-900 mb-1">
                        {loadingUniversityDetails ? '-' : (universityDetails?.total_students || 0)}
                      </div>
                      <div className="text-sm text-gray-600">Total Students</div>
                    </div>
                    <div className="text-center p-4 bg-gray-50 rounded-xl border border-gray-200">
                      <div className="text-3xl font-bold text-gray-900 mb-1">
                        {loadingUniversityDetails ? '-' : (universityDetails?.total_branches || 0)}
                      </div>
                      <div className="text-sm text-gray-600">Branches</div>
                    </div>
                    <div className="text-center p-4 bg-gray-50 rounded-xl border border-gray-200">
                      <div className="text-3xl font-bold text-gray-900 mb-1">
                        {loadingUniversityDetails ? '-' : (universityDetails?.total_subjects || 0)}
                      </div>
                      <div className="text-sm text-gray-600">Subjects</div>
                    </div>
                    <div className="text-center p-4 bg-gray-50 rounded-xl border border-gray-200">
                      <div className="text-3xl font-bold text-gray-900 mb-1">
                        {loadingUniversityDetails ? '-' : (universityDetails?.total_semesters || 0)}
                      </div>
                ...
                <section>
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-xl font-bold text-gray-900">University Information</h3>
                    </div>
                    ...
                    {loadingUniversityDetails ? (
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <div className="relative">
                            <div className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900">
                              {universityDetails?.name || 'Not available'}
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <div className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900">
                              {universityDetails?.code || 'Not available'}
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <div className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900">
                              {[universityDetails?.city, universityDetails?.state, universityDetails?.country].filter(Boolean).join(', ') || 'Not available'}
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between pb-3 border-b border-gray-100">
                        ...
                        <span className="font-semibold text-gray-900">University Admin</span>
                      </div>
                      <div className="flex items-center justify-between pb-3 border-b border-gray-100">
                      ...
                      <div className="flex items-center justify-between pb-3 border-b border-gray-100">
                        ...
                        <span className="font-semibold text-gray-900">{universityDetails?.name ? 'Assigned' : 'N/A'}</span>
                      </div>
                      <div className="flex items-center justify-between">
