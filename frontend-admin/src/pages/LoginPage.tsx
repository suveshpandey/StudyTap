...
import { Users, Shield, Mail, Lock, GraduationCap, Eye, EyeOff, ArrowRight, Bot, Brain, TrendingUp, Clock, Smartphone } from 'lucide-react';
    ...
    <div className="min-h-screen flex bg-gray-50 font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-indigo-500 to-purple-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          ...
          <div className="mb-12">
            <h2 className="text-4xl font-bold mb-6 leading-tight">Welcome Back to Your Admin Portal</h2>
            <p className="text-xl text-white/90 mb-8">Manage your university, students, and academic content with AI-powered tools and comprehensive analytics.</p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">Streamline university operations with intelligent automation</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">Track student progress and academic performance</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">Monitor your university's growth with detailed insights</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-md">
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-gray-600">Sign in to continue managing your university</p>
            </div>
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                <label className="flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 rounded focus:ring-indigo-600 focus:ring-2"
                  />
              ...
              <p className="text-center text-sm text-gray-600">
                ...
                <Link to="/signup" className="font-semibold text-indigo-600 hover:text-indigo-700 transition-all">
                  Sign Up Free
                </Link>
              </p>
            </motion.form>
